...
export const metadata: Metadata = {
  title: 'Voice of Maheedhar - Telugu Spiritual & Devotional Content | Telugu Voice',
  description: 'Experience spiritual and devotional content in Telugu by Voice of Maheedhar. Listen to bhajans, spiritual discourses, and divine stories.',
  keywords: 'Voice of Maheedhar, Telugu spiritual content, devotional songs Telugu, Telugu bhajans, spiritual discourses Telugu, divine stories Telugu',
  openGraph: {
    title: 'Voice of Maheedhar - Telugu Spiritual & Devotional Content',
    description: 'Immerse yourself in Telugu spiritual and devotional content. Bhajans, discourses, and divine stories.',
      ...
      <div className="container mx-auto px-6">
        {error ? (
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-[#E2E8F0] mb-8">Videos of Voice of Maheedhar</h2>
