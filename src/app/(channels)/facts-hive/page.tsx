...
export const metadata: Metadata = {
  ...
  description:
    "Discover fascinating facts and knowledge in Telugu. Watch engaging videos about science, history, technology, and more from Facts Hive channel.",
  keywords:
    "Facts Hive, Telugu facts, knowledge sharing, Telugu educational content, interesting facts in Telugu, Telugu science videos",
  openGraph: {
    title: "Facts Hive - Fascinating Facts and Knowledge Sharing",
    description:
      "Explore interesting facts and knowledge in Telugu. Science, history, technology, and more.",
