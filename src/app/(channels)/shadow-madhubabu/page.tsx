...
export const metadata: Metadata = {
  ...
  description: 'Listen to captivating Telugu mystery thriller audiobooks by Shadow Madhubabu. Enjoy detective stories, crime thrillers, and suspense novels in Telugu.',
  keywords: 'Shadow Madhubabu, Telugu audiobooks, mystery thrillers, Telugu detective stories, crime novels Telugu, Telugu suspense stories',
  openGraph: {
    title: 'Shadow Madhubabu - Telugu Mystery Thriller Audiobooks',
    description: 'Immerse yourself in thrilling Telugu mystery audiobooks and detective stories.',
      ...
      <div className="container mx-auto px-6">
        {error ? (
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-8">Vidoes of Shadow Madhubabu Audiobooks</h2>
